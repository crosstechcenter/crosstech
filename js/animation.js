...
vertex3d.prototype = {
	...
	var strokeColor = "rgba(226, 74, 63, 0.1)";
	var backgroundColor = "rgba(226, 74, 63, 0.1)";
	...
	var textSet = [
		{text:"CROSSTECH", sphereRadius:140, sphereSpace:80, unitTime:100, time:1000}
	];
	...
	var start = function() {
		...
		setInterval(function() {
			...
			if(invertCV.execution() > 0.7) {
				strokeColor = "rgba(226, 74, 63, 0.3)";
				backgroundColor = "rgba(255,255,255,0.1)";
			} else {
				strokeColor = "rgba(122, 194, 79, 0.3)";
